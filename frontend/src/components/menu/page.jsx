  ...
  useEffect(() => {
    ...
    if (sessionStorage.getItem("code") && storedData === null) {
      async function getAccessToken() {
        await fetch(
          "https://ethapp-wine.vercel.app/getAccessToken?code=" + codeParams,
          {
            method: "GET",
          }
        )
                  ...
                  {userData ? (
                    <div className="space-x-4 flex">
                      <img
                        ...
                        onMouseOver={toggleDetails}
                        alt="Profile"
                        className=" w-10 h-10 rounded-full"
                      />
                      <div>
                        {details ? (
                          <div className=" text-white w-[200px] fixed top-28 right-80 bg-black border-2 dark:bg-gray-900 rounded-2xl p-4  z-50">
