    ...
    return (
        ...
        <div>
            ...
            {repos.map((repo) => {
                return (
                    <>
                      <div className="mx-10 bg-gradient-to-br from-purple-900 to-black rounded-xl overflow-hidden shadow-lg border border-purple-700">
      <div className="p-5">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h2 className="text-white font-bold text-xl">LyricFlip</h2>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="rounded-lg bg-gray-900 px-4 py-3">
            ...
            <div className="flex items-center">
              ...
              <span className="text-white font-bold text-2xl">61</span>
            </div>
          </div>
          <div className="rounded-lg bg-gray-900 px-4 py-3">
            <div className="text-gray-400 text-xs mb-1">Good first issues</div>
            <div className="flex items-center">
              <div className="w-4 h-4 rounded-full bg-green-500 mr-2"></div>
              <span className="text-white font-bold text-2xl">38</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4">
          <p className="text-gray-300 text-sm">
            LyricFlip is an interactive on-chain card game where players test their music knowledge by guessing song titles or...
          </p>
        </div>

        {/* Tags */}
        <div className="flex space-x-2 mb-4">
          <span className="px-3 py-1 rounded-full bg-gray-800 text-xs text-gray-300">DeFi</span>
          <span className="px-3 py-1 rounded-full bg-gray-800 text-xs text-gray-300">Gaming</span>
        </div>

        {/* Progress bars */}
        <div className="flex items-center mb-2">
          <div className="w-8 h-8 rounded-full bg-blue-900 flex items-center justify-center text-xs text-white mr-2">TS</div>
        ...
        <div className="flex items-center mb-2">
          <div className="w-8 h-8 rounded-full bg-yellow-900 flex items-center justify-center text-xs text-white mr-2">JS</div>
          <div className="flex-1 h-2 bg-gray-800 rounded-full overflow-hidden">
