      ...
      <div className="bg-white dark:bg-black">
        <div className="flex">
          <div className="w-1/2 px-20">
            <div className={` `}>
              <button
                className={` mt-20 p-4 rounded-3xl bg-gray-100 dark:bg-[#171717]`}
              >
            ...
            <div className="flex space-x-4">
              <button
                className="flex text-black items-center justify-center mt-10 p-4 rounded-3xl bg-gray-100 dark:bg-[#14f195]"
                onClick={() => router.push("/ViewBounties")}
              >
                START CONTRIBUTING
              </button>
              <button
                className="flex items-center border-2 border-white justify-center mt-10 p-4 rounded-3xl "
            ...
            <div className="text-xl pt-10">
              GitFund is a decentralized platform that rewards GitHub
              contributions with cryptocurrency. Developers earn through
              bounties, while project owners track progress and distribute
              payouts transparently. It bridges open-source development with
              blockchain, fostering innovation and collaboration.
            </div>
          </div>
          <div className="w-1/2">
